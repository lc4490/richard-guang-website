              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="textSecondary">
                    {listing.location} New York, New York, {listing.postal_code}
                  </Typography>
                  <Typography
                    variant="h6"
                    sx={{
                      ...
                      `${listing["listing-item__feat__value"]} ${
                        listing["listing-item__feat__description"]
                          ? listing["listing-item__feat__description"]
                              .charAt(0)
                              .toUpperCase() +
                            listing["listing-item__feat__description"].slice(1)
                          : ""
                      }`}
                      ...
                      ` | ${listing["listing-item__feat__value 2"]} ${
                        listing["listing-item__feat__description 2"]
                          ? listing["listing-item__feat__description 2"]
                              .charAt(0)
                              .toUpperCase() +
                            listing["listing-item__feat__description 2"].slice(
                              1
                            )
                          : ""
                      }`}
                      ...
                      ` | ${listing["listing-item__feat__value 3"]} ${
                        listing["listing-item__feat__description 3"]
                          ? listing["listing-item__feat__description 3"]
                              .charAt(0)
                              .toUpperCase() +
                            listing["listing-item__feat__description 3"].slice(
                              1
                            )
                          : ""
                      }`}
